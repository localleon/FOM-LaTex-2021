...
\usepackage[a4paper, left=4cm, right=2cm, top=3.8cm, bottom=3cm,footskip=1cm,headsep=1cm]{geometry}
...
% define font size of both header and footer 
\newcommand{\changefont}{%
    \fontsize{12}{11}\selectfont
}

% Header Seitenzahl oben, links, entsprechend Leitfaden , kein Abstand zur Linie setzen
\fancyhead[R]{\raisebox{-.5\baselineskip}[0pt][0pt]{\changefont \nouppercase\leftmark}}
\renewcommand{\headrulewidth}{1.5pt}

% Footer, set font lower 
\fancyfoot[R]{\changefont \textcolor{gray}{\myTitel} | \textcolor{teal}{\thepage}}
\renewcommand{\footrulewidth}{1.5pt}

% these rules set the header color and footer 
