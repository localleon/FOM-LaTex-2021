...
\usepackage[a4paper, left=4cm, right=2cm, top=4cm, bottom=2cm,footskip=1cm]{geometry}
...
\fancyhead[R]{\raisebox{-.5\baselineskip}[0pt][0pt]{\changefont \rightmark}}
\renewcommand{\headrulewidth}{1.5pt}

% Footer, set font lower 
\fancyfoot[R]{\changefont \textcolor{gray}{\myTitel} | \textcolor{teal}{\thepage}}

% these rules set the header color 
